...
<section class="intro">
    <div class="container">
        ...
        <div class="mb-3">
            ...
            <a href="pdf/facturas.php" target="_blank" class="btn btn-info">Imprimir</a>
        </div>
            ...
            <?php foreach ((array) $rows as $row) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="edit.php?id=<?=$row['numero']?>" class="btn btn-primary">Editar</a>
                        <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#iddel<?=$row['numero']?>">Eliminar</a>
