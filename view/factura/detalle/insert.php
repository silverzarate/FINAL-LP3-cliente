<?php
    class detalleFactura  {
        ...
        public function getDetalles($sesion) {
            return json_decode(file_get_contents("tmpdetallefacturas$sesion.json"), true);
        }
        ...
        public function putJson($detalles,$sesion) {
            file_put_contents("tmpdetallefacturas$sesion.json", json_encode($detalles, JSON_PRETTY_PRINT));
        }
    }
?>